...
() {
  ...
  # typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#d55fde'
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#42a2f0'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#d55fde'
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND='#f7f7f7'
